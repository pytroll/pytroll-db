...
dcm = pytroll_db.DCManager(
    'postgresql://iceopr:Hot_Eyes@devsat-lucid:5432/testdb2')
...
nf1 = dcm.create_file(
    'test101', file_type_name='HRPT', file_format_name='hrpt level 0')
print nf
p = dcm.get_parameter('orbit_number')

pv = dcm.create_parameter_value(666, file_obj=nf, parameter=p)
pv = dcm.create_parameter_value(
    666, uid='test101', parameter_name='orbit_number')
...
pls = dcm.create_parameter_linestring(
    wkt_o, uid="test100", parameter_name="sub_satellite_track")
